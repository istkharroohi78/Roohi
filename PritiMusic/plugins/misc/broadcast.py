...
# SELF PROMO ASSETS
# ==========================================
PROMO_IMAGE = "https://files.catbox.moe/7xp3l4.jpg"
PROMO_TEXT = """
⊚ ᴛʜɪꜱ ɪꜱ [✶ Sizzu ᴍᴜꜱɪᴄ ᴄʟᴏɴᴇ ✶](https://t.me/SizzuMusicBot)
...
PROMO_BUTTON = InlineKeyboardMarkup(
    [[InlineKeyboardButton("🎵 Aᴅᴅ ᴍᴇ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ 🎧", url="https://t.me/SizzuMusicBot?startgroup=true")]]
)
